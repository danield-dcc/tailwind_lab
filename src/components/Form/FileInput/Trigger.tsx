...
export function Trigger() {
  ...
  return (
    <label
      htmlFor={id}
      className="group flex-1 cursor-pointer flex flex-col items-center gap-3 rounded-lg border border-zinc-300 px-6 py-6 text-center text-zinc-500 shadow-sm hover:border-violet-200 bg-violet-25 hover:text-violet-500 dark:bg-zinc-900 dark:border-zinc-800 dark:hover:border-zinc-700 dark:hover:bg-zinc-800  dark:hover:text-violet-300"
    >
